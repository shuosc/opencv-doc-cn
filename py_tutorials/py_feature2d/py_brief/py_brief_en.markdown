# BRIEF (Binary Robust Independent Elementary Features) {#tutorial_py_brief_en}
...
Below code shows the computation of BRIEF descriptors with the help of CenSurE detector. (CenSurE detector is called STAR detector in OpenCV) note, that you need [opencv contrib](https://github.com/opencv/opencv_contrib)) to use this.
```python
import numpy as np
import cv2
